...
function sc_extern_c_hack_3()
    @ccall libsc.sc_extern_c_hack_3()::Cvoid
end
...
function sc_extern_c_hack_4()
    @ccall libsc.sc_extern_c_hack_4()::Cvoid
end
...
!!! note
    ...
    In contrast to t8_get_version_major and t8_get_version_minor the patch version number must be computed from *T8_VERSION_POINT* This computation may result in an error or an invalid patch number. In that case a negative patch version is returned.
