...
@testset "readmshfile" begin
    @testset "test_msh_file_vers2_ascii" begin
        fileprefix = joinpath("testfiles", "test_msh_file_vers2_ascii")
    ...
    @testset "test_msh_file_vers4_ascii" begin
        fileprefix = joinpath("testfiles", "test_msh_file_vers4_ascii")
        filename = fileprefix * ".msh"
    ...
    @testset "test_msh_file_vers2_bin" begin
        fileprefix = joinpath("testfiles", "test_msh_file_vers2_bin")
        filename = fileprefix * ".msh"
    ...
    @testset "test_msh_file_vers4_bin" begin
        fileprefix = joinpath("testfiles", "test_msh_file_vers4_bin")
        filename = fileprefix * ".msh"
