...
### Prototype
```c
static inline void t8_mat_mult_vec (double mat[3][3], const double a[3], double b[3]);
```
"""
...
### Prototype
```c
static inline void t8_mat_mult_mat (double A[3][3], double B[3][3], double C[3][3]);
```
"""
...
"""
    t8_cmesh_new_triangulated_spherical_surface_icasohedron(radius, comm)

### Prototype
```c
t8_cmesh_t t8_cmesh_new_triangulated_spherical_surface_icasohedron (const double radius, sc_MPI_Comm comm);
```
"""
function t8_cmesh_new_triangulated_spherical_surface_icasohedron(radius, comm)
    @ccall libt8.t8_cmesh_new_triangulated_spherical_surface_icasohedron(radius::Cdouble, comm::MPI_Comm)::t8_cmesh_t
end
...
### Prototype
```c
t8_cmesh_t t8_cmesh_new_prismed_spherical_shell (const double inner_radius, const double shell_thickness, const int num_levels, const int num_layers, sc_MPI_Comm comm);
```
"""
function t8_cmesh_new_prismed_spherical_shell(inner_radius, shell_thickness, num_levels, num_layers, comm)
    @ccall libt8.t8_cmesh_new_prismed_spherical_shell(inner_radius::Cdouble, shell_thickness::Cdouble, num_levels::Cint, num_layers::Cint, comm::MPI_Comm)::t8_cmesh_t
end
...
# no prototype is found for this function at t8_cmesh_testcases.h:41:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:46:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:51:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:56:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:61:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:66:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:71:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:76:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:81:1, please use with caution
"""
...
# no prototype is found for this function at t8_cmesh_testcases.h:88:1, please use with caution
"""
...
"""
    t8_forest_element_from_ref_coords(forest, ltreeid, element, ref_coord, num_coords, coords_out, stretch_factors)

### Prototype
```c
void t8_forest_element_from_ref_coords (t8_forest_t forest, t8_locidx_t ltreeid, const t8_element_t *element, const double *ref_coord, const size_t num_coords, double *coords_out, sc_array_t *stretch_factors);
```
"""
function t8_forest_element_from_ref_coords(forest, ltreeid, element, ref_coord, num_coords, coords_out, stretch_factors)
    @ccall libt8.t8_forest_element_from_ref_coords(forest::t8_forest_t, ltreeid::t8_locidx_t, element::Ptr{t8_element_t}, ref_coord::Ptr{Cdouble}, num_coords::Csize_t, coords_out::Ptr{Cdouble}, stretch_factors::Ptr{sc_array_t})::Cvoid
end
...
Create a new spherical\\_surface geometry.

### Returns
A pointer to an allocated geometry struct.
### Prototype
```c
t8_geometry_c * t8_geometry_spherical_surface_new ();
```
"""
function t8_geometry_spherical_surface_new()
    @ccall libt8.t8_geometry_spherical_surface_new()::Ptr{t8_geometry_c}
end
...
### Prototype
```c
t8_geometry_c * t8_geometry_spherical_shell_new ();
```
"""
function t8_geometry_spherical_shell_new()
    @ccall libt8.t8_geometry_spherical_shell_new()::Ptr{t8_geometry_c}
end
...
const T8_SQRT3 = 1.7320508075688772
